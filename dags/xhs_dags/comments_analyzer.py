...
2. 结合【用户名】和【评论内容】进行多层分析：
 a. 根据用户名判断该用户是否为同行。同行用户通常为你的竞争对手，一般不会成为你的客户，且他们可能通过评论中传播行业资源、邀请私聊或展示服务来引流，其评论内容和行为表现与客户显著不同，应优先判断为“低意向”。
 b. 解析评论内容表达的情绪与需求，关注是否包含如下典型客户意向特征：
    - 积极夸赞或认可行业相关产品/服务的质量和效果；
    - 询问购买方式、库存情况、服务细节、价格、优惠等信息；
    - 请求推荐适合自己的产品或服务；
    - 呼吁或者表达愿意进一步互动、私聊、咨询；
    - 表示考虑或计划购买、使用相关服务。
 这类评论体现用户对行业相关产品或服务的兴趣和购买潜力，大概率判定为“高意向”。
 c. 对于中性表达、观望态度、与【理想客户画像】契合度一般的，可判定为“中意向”。
 d. 对于负面批评或明显表现为与【理想客户画像】不契合的，则判定为“低意向”。
3. 结合用户名和评论内容的综合分析结果，以及与【理想客户画像】的契合程度，输出最终意向等级：“高意向”、“中意向”或“低意向”，避免因同行伪装产生误判。
====
#Reasoning steps
